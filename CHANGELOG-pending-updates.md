...
- `js/templates/quiz.js` — quiz template branding updates
- `js/workspace.js` — workspace module branding updates
...
## Files Modified
- CHANGELOG-help-mode.md, CHANGELOG.md
- ai-worker-openrouter.js, public/ai-worker-openrouter.js
- desktop-app/README.md, desktop-app/neutralino.config.json, desktop-app/package.json
- firestore.rules, public/firestore.rules
- index.html, src/main.js
- js/ai-assistant.js, js/cloud-share.js, js/workspace.js
- js/templates/coding.js, js/templates/quiz.js
