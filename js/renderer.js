...
(function (M) {
    ...
    M.renderMarkdownToContainer = function (container) {
        ...
        var gameMarkdown = M.transformGameMarkdown
            ...
            : linuxMarkdown;
        // Chain Podcast tag transform
        var podcastMarkdown = M.transformPodcastMarkdown
            ? M.transformPodcastMarkdown(gameMarkdown)
            : gameMarkdown;
        // Chain Git tag transform
        var gitMarkdown = M.transformGitMarkdown
            ? M.transformGitMarkdown(podcastMarkdown)
            : podcastMarkdown;
    ...
    M.renderMarkdown = async function () {
        try {
            ...
            // Podcast: bind Podcast Generator card actions
            if (M.bindPodcastPreviewActions) M.bindPodcastPreviewActions(M.markdownPreview);
            ...
            // Annotate: bind canvas annotation card actions
            if (M.bindAnnotatePreviewActions) M.bindAnnotatePreviewActions(M.markdownPreview);
