...
| Date | Feature / Update |
|------|-----------------|
| **2026-03-09** | ✉️ **Email to Self** — share result modal now includes an "Email to Self" section; enter your email address → opens default email client (Gmail, Outlook, Apple Mail, etc.) with share link pre-filled in body + auto-downloads the raw `.md` file for attachment; email persisted in localStorage for convenience; shake animation on invalid input; zero backend required (`mailto:` protocol) |
